...
class Expression;
...
#else
    const std::string c_FloatType = "double";
#endif
    ...
    inline ExpressionCPtr pow(const ExpressionCPtr &expr0, const double &expr1);
    inline ExpressionCPtr pow(const double &expr0, const ExpressionCPtr &expr1);
    inline ExpressionCPtr fmax(const ExpressionCPtr &expr0, const ExpressionCPtr &expr1);
    inline ExpressionCPtr fmax(const ExpressionCPtr &expr0, const double expr1);
    inline ExpressionCPtr fmax(const double expr0, const ExpressionCPtr &expr1);
    ...
    inline ExpressionCPtr operator+(const double expr0, const ExpressionCPtr &expr1);
    inline ExpressionCPtr operator+(const ExpressionCPtr &expr0, const double expr1);
    inline ExpressionCPtr &operator+=(ExpressionCPtr &expr0, const ExpressionCPtr &expr1);
    inline ExpressionCPtr &operator+=(ExpressionCPtr &expr0, const double expr1);
    inline ExpressionCPtr operator-(const ExpressionCPtr &expr0, const ExpressionCPtr &expr1);
    inline ExpressionCPtr operator-(const double expr0, const ExpressionCPtr &expr1);
    inline ExpressionCPtr operator-(const ExpressionCPtr &expr0, const double expr1);
    inline ExpressionCPtr &operator-=(ExpressionCPtr &expr0, const ExpressionCPtr &expr1);
    ...
    inline BooleanCPtr Gt(const double expr0, const ExpressionCPtr &expr1);
    inline BooleanCPtr Gt(const ExpressionCPtr &expr0, const double expr1);
    inline BooleanCPtr Gte(const ExpressionCPtr &expr0, const ExpressionCPtr &expr1);
    inline BooleanCPtr Gte(const double expr0, const ExpressionCPtr &expr1);
    inline BooleanCPtr Gte(const ExpressionCPtr &expr0, const double expr1);
    inline BooleanCPtr Eq(const ExpressionCPtr &expr0, const ExpressionCPtr &expr1);
    inline BooleanCPtr Eq(const double expr0, const ExpressionCPtr &expr1);
    inline BooleanCPtr Eq(const ExpressionCPtr &expr0, const double expr1);
    inline BooleanCPtr Lte(const ExpressionCPtr &expr0, const ExpressionCPtr &expr1);
    inline BooleanCPtr Lte(const double expr0, const ExpressionCPtr &expr1);
    inline BooleanCPtr Lte(const ExpressionCPtr &expr0, const double expr1);
    inline BooleanCPtr Lt(const ExpressionCPtr &expr0, const ExpressionCPtr &expr1);
    inline BooleanCPtr Lt(const double expr0, const ExpressionCPtr &expr1);
    inline BooleanCPtr Lt(const ExpressionCPtr &expr0, const double expr1);
    ...
    public:
        ...
        void Register(const ExpressionCPtr &expr) {
            ...
            m_ExprMap[expr] = static_cast<int>(m_ExprMap.size());
        }
    ...
    public:
        ...
        virtual double GetConstantVal() const {
            return 0.0;
        }
    };
    ...
    public:
        ...
        void Register(EmitHelper &helper) const override {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
        }
        std::string GetEmitName(const EmitHelper &helper) const override {
            if (m_Index >= 0) {
        ...
        ExpressionCPtrVec Children() const override {
            return {};
        }
        ExpressionCPtrVec Dervs() const override {
            return {};
        }
    ...
    public:
        static std::shared_ptr<const Constant> Create(const double value) {
            return std::make_shared<Constant>(value);
        }

        explicit Constant(const double value) : m_Value(value) {
        }
        ...
        double GetConstantVal() const override {
            return m_Value;
        }
    ...
    public:
        explicit UnaryExpr(const ExpressionCPtr &expr) : m_Expr(expr) {
        }
        void Register(EmitHelper &helper) const override {
            m_Expr->Register(helper);
    ...
    public:
        ...
        explicit Negate(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
            helper.PrintTab(os);
            os << GetEmitName(helper) << " = -" << m_Expr->GetEmitName(helper) << ";" << std::endl;
    ...
    public:
        ...
        explicit Square(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
            helper.PrintTab(os);
    ...
    public:
        ...
        explicit Sin(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
            helper.PrintTab(os);
    ...
    public:
        ...
        explicit Cos(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
            helper.PrintTab(os);
    ...
    public:
        ...
        explicit Tan(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
            helper.PrintTab(os);
    ...
    public:
        ...
        explicit Sqrt(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
            helper.PrintTab(os);
    ...
    public:
        ...
        explicit Inverse(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
            helper.PrintTab(os);
    ...
    public:
        ...
        explicit ASin(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
            helper.PrintTab(os);
    ...
    public:
        ...
        explicit ACos(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
    ...
    public:
        ...
        explicit Exp(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
            helper.PrintTab(os);
    ...
    public:
        ...
        explicit Log(const ExpressionCPtr &expr) : UnaryExpr(expr) {
        }
        void Emit(const EmitHelper &helper, std::ostream &os) const override {
            helper.PrintTab(os);
    ...
    public:
        ...
        virtual std::string GetEmitName(const EmitHelper &helper) const override {
    ...
    inline void EndFunction(const std::vector<std::pair<std::string, ExpressionCPtrVec>> &outputs) {
        if (!g_Function->splitStack.empty()) {
    ...
    inline void PushExprToBlock(const ExpressionCPtr &expr) {
        if (g_Function != nullptr && g_Function->curBlock != nullptr) {
    ...
    void EmitGradHessian(const std::shared_ptr<Function> &func, const ExpressionCPtrVec &wrt, const ExpressionCPtr &dep, std::ostream &os, bool emitIspc);
    void EmitGrad(const std::shared_ptr<Function> &func, const ExpressionCPtrVec &wrt, const ExpressionCPtr &dep, std::ostream &os, bool emitIspc);
    ...
    public:
        ...
        virtual ~Library();
        void RegisterFunc(std::shared_ptr<Function> func);
        void RegisterFuncDerv(std::shared_ptr<Function> func, const ExpressionCPtrVec &wrt, const ExpressionCPtr &dep, bool emitIspc = false, bool hessian = false);
