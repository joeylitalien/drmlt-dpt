...
/**
 * utility to AlignedStdVector matrix
*/
inline void printMatrix(const AlignedStdVector &vMatrix, const size_t dim){
    Eigen::Map<const Matrix, Eigen::Aligned> matrix(&vMatrix[0], dim, dim);
    for (int i = 0; i < dim; ++i) {
        for (int j = 0; j < dim; ++j) {
            std::cout << matrix(i, j) << ", ";
        }
...
*/
inline void printMatrix(const Matrix &matrix, const size_t dim) {
    for (int i = 0; i < dim; ++i) {
        for (int j = 0; j < dim; ++j) {
            std::cout << matrix(i, j) << ", ";
        }
...
/**
 * utility to print AlignedStdVector vector
*/
inline void printVector(const AlignedStdVector &vVector, const size_t dim) {
    Eigen::Map<const Vector, Eigen::Aligned> vector(&vVector[0], dim, 1);
    for (int i = 0; i < dim; ++i) {
        std::cout << vector(i) << ", ";
    }
    std::cout << std::endl;
...
/**
 * utility to print eigen vector
*/
inline void printVector(const Vector &vector, const size_t dim) {
